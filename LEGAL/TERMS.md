...
**Operator:** Shenzhen XXX Technology Co., Ltd. (PRC, Shenzhen)  
**Hosting Location:** Hong Kong (HK)  
**Contact:** support@YOUR_DOMAIN (replace)

## 1. Acceptance
By using the service, you agree to these Terms, the Privacy Notice, and the Marketplace Policy.

## 2. Accounts
- You are responsible for maintaining the confidentiality of your credentials.
- Usernames must not be email addresses or phone numbers.
- Password recovery uses your email address.
- We may suspend or terminate accounts for violations of these Terms or the Marketplace Policy.
...
You grant us a limited license to host and display marketplace content for operating the service.
