...
- Finished the public release/publish chain for `v1.0.1`: Android APK published at SHA-256 `7c76d548f3ced5b69f71a65ef9fe3bf5d3e7a831a635a62ba57122ef5cbe4f15`, Windows ZIP published at SHA-256 `f355e03827c9f2112ec4fa905c83efc9f358832cd10419fa87061fa5d3864959`, GitHub Release assets refreshed at `https://github.com/tutor1on1-org/tutor1on1/releases/tag/v1.0.1`, website static content re-synced, the Windows publish script was hardened to retry candidate/canonical URL checks after a transient `curl` timeout during candidate verification, and the GitHub release retry path now retries transient Windows schannel failures while preserving already-built Android/Windows artifacts during GitHub-only reruns.
