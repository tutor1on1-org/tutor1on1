...
func registerRoutes(app *fiber.App, deps handlers.Dependencies) {
	...
	api.Get("/teacher/courses/sync-state2", teacherCourses.GetCoursesSyncState2)
	api.Get("/teacher/courses/sync-state1", teacherCourses.GetCoursesSyncState1)
	...
	api.Get("/enrollments/sync-state2", enrollments.GetEnrollmentsSyncState2)
	api.Get("/enrollments/sync-state1", enrollments.GetEnrollmentsSyncState1)
	...
	api.Get("/sync/download-state2", syncLimiter.Handler(middleware.KeyByIP), syncDownload.State2)
	api.Get("/sync/download-state1", syncLimiter.Handler(middleware.KeyByIP), syncDownload.State1)
